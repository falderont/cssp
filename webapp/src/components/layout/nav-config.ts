...
export const OPS_NAV: NavItem[] = [
  ...
  { href: "/ops/admin/regions", label: "Regions & Countries", icon: "Map", section: "Global administration", roles: [SYS_ADMIN] },
  { href: "/ops/admin/facilities", label: "Facilities", icon: "Building2", section: "Global administration", roles: [SYS_ADMIN] },
